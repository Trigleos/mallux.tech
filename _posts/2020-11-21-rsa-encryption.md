...
summary: "Extract RSA keys from executable and decrypt encrypted document"
author: trigleos
date: '2020-11-21 20:00:00 +0200'
category: ['Reversing','Linux_Reversing','RSA']
tags: Linux Reversing, Reversing, C#
thumbnail: /assets/img/posts/rsa-encryption/rsa.jpg
keywords: Reversing, RSA, Encryption, CTF
usemathjax: false
permalink: /blog/rsa-encryption/
---
...
![rsa1](/assets/img/posts/rsa-encryption/rsa1.png)

Looking into the preparation for the call in the executable,  we see the following:

![rsa2](/assets/img/posts/rsa-encryption/rsa2.png)
...
![rsa3](/assets/img/posts/rsa-encryption/rsa3.png)
...
![rsa4](/assets/img/posts/rsa-encryption/rsa4.png)
...
![rsa5](/assets/img/posts/rsa-encryption/rsa5.png)
...
![rsa6](/assets/img/posts/rsa-encryption/rsa6.png)
...
![rsa7](/assets/img/posts/rsa-encryption/rsa7.png)

![rsa8](/assets/img/posts/rsa-encryption/rsa8.png)

We cleary see that we get a lot of 0x00 bytes after an array size of 512 bytes. Divide that by the earlier established length of 32 and we see that in this case, a word is 16 bytes long (I still think that's weird). 512 bytes is quite safe for an RSA key though so I guess this would closely remember real life conditions. Now that we know that the key is 512 bytes long, we just need to extract it (easier said that done, this involved a lot of copy-pasting and reversing the bytes because of endianness). After doing that we finally get d which is the glorious number
```
